...
- [x] `runbook-pgbackrest-s3-migration.md` — move pgBackRest off node-local repos onto the shared Garage `pg-backup` bucket, plus `restore_command`, per [ADR-0042](adr/0042-pgbackrest-shared-repo-and-restore-command.md). Config committed 2026-08-26, **not yet run**
