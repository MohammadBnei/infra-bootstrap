...
| [0041](0041-fleet-native-oidc-not-forwardauth.md) | `fleet.bnei.dev` moves to the Native OIDC tier (amends ADR-0039 Decision 3); previews stay on forwardAuth | Proposed (Decision 3 reversed same-day — basic-admin-auth dropped from the console; see the in-ADR amendment) |
